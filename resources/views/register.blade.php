...
<div class="container">
    ...
    <div class="col-md-12 text-center">
        ...
        {!! Form::text('name','',['type'=>'email','id'=>'inputEmail','class'=>'form-control','autofocus','required','placeholder'=>'Full Name']) !!}
        <label for="inputEmail" class="sr-only">Email address</label>
        {!! Form::email('email','',['type'=>'email','id'=>'inputEmail','class'=>'mt-2 form-control','autofocus','required','placeholder'=>'Email Address']) !!}
        <label for="inputPassword" class="sr-only">Password</label>
        {!! Form::password('password',['id'=>'inputPassword','class'=>'form-control mt-2','placeholder'=>'Password','required']) !!}
        <label for="inputPassword" class="sr-only">Password</label>
        {!! Form::password('password_confirmation',['id'=>'inputPassword','class'=>'form-control','placeholder'=>'Confirm Password','required']) !!}
